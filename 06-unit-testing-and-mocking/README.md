...
Наличната имплементация е [тук](https://github.com/fmi/java-course/tree/master/06-unit-testing-and-mocking/lab/shopping-cart/src/bg/sofia/uni/fmi/mjt/shopping).
